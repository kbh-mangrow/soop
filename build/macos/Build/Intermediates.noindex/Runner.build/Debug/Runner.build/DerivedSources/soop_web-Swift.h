...
#ifndef SOOP_WEB_SWIFT_H
#define SOOP_WEB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="soop_web",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC8soop_web11AppDelegate")
...
SWIFT_CLASS("_TtC8soop_web17MainFlutterWindow")
